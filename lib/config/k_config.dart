...
setTheme() {
  ...
  KConfig.radius = 8.0;
  KConfig.ads = {
    'app': Platform.isAndroid ? 'ca-app-pub-6380644639947620~8641157171' : '',
    'banner':
        Platform.isAndroid ? 'ca-app-pub-6380644639947620/3376194531' : '',
    'inter': Platform.isAndroid ? 'ca-app-pub-6380644639947620/2063112862' : '',
  };
  KConfig.android_package = 'com.kode4u.khmerqrscanner';
  KConfig.ios_package = '';

//config theme data
  KColor.l_primary_l_color = const Color(0xFF64B5F6);
  KColor.l_primary_color = Colors.blue;
